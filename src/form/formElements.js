...
const btnHide=document.querySelector("#btn-delete-solicitud");
const btnBar=document.querySelector("#btns-solicitudes");
const tableBody = document.querySelector('#table-body');

export{formulario,nombre,apellido,email,numero,motivo,enviar,btnSolicitud,btnHide,btnBar,tableBody};